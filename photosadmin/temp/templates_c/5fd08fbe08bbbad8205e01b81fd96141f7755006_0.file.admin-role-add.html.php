<?php
/* Smarty version 3.1.29, created on 2016-08-28 11:26:27
  from "D:\WWW\photos\photosadmin\templates\admin-role-add.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_57c259e3c55ac6_58158746',
  'file_dependency' => 
  array (
...
function content_57c259e3c55ac6_58158746 ($_smarty_tpl) {
		...
		<form action="" method="post" class="form form-horizontal" id="form-admin-role-add">
			<div class="row cl">
				...
				<div class="formControls col-5">
					<input type="text" class="input-text" value="" placeholder="请输入角色ID" id="roleid" name="roleid" datatype="n1-2" nullmsg="角色ID不能为空">
				</div>
				<div class="col-4"> </div>
			</div>
			<div class="row cl">
