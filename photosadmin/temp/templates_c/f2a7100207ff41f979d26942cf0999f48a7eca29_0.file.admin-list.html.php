<?php
/* Smarty version 3.1.29, created on 2016-10-07 15:48:00
  from "D:\WWW\photos\photosadmin\templates\admin-list.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_57f75330111ea2_45788290',
  'file_dependency' => 
  array (
...
function content_57f75330111ea2_45788290 ($_smarty_tpl) {
...
<body>
    ...
    <div class="pd-20">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="javascript:;" onclick="multitude_data_del()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量刪除</a> <a href="javascript:;" onclick="admin_add('添加管理员','index.php?controller=admin&amp;method=admin_add','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span> <span class="r">共有数据：<strong><?php echo $_smarty_tpl->tpl_vars['admin_info_counts']->value;?>
</strong> 条</span>
        </div>
        <div>
...
&nbsp;&nbsp;页</span></span>
        ...
        <div style="float: right;margin: 0px 20px 20px 0px;">
            ...
            <span><a href='index.php?controller=admin&amp;method=admin_list&amp;curr_page=<?php echo $_smarty_tpl->tpl_vars['curr_page']->value-1;?>
'>上一页</a></span>
            <!-- <?php }?> -->
...
'>下一页</a></span>
            <!-- <?php }?> -->
            <span><a href='index.php?controller=admin&amp;method=admin_list&amp;curr_page=<?php echo $_smarty_tpl->tpl_vars['total_page']->value;?>
'>尾页</a></span>
        </div>
    </div>
