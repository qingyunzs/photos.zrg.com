...
?>
				...
				<dl id="menu-picture">
					...
					<dd>
						<ul>
							...
							<li><a _href="picture-category.html" href="javascript:void(0)">图片分类</a></li>
						</ul>
					</dd>
				</dl>
				<dl id="menu-product">
				...
				<dl id="menu-member">
					...
					<dd>
						<ul>
							<li><a _href="index.php?controller=member&method=member_list" href="javascript:;">会员列表</a></li>
				...
				<dl id="menu-system">
					...
					<dd>
						<ul>
							<li><a _href="index.php?controller=system&method=system_setting" href="javascript:void(0)">系统设置</a></li>
							<li><a _href="index.php?controller=system&method=system_menu_manage" href="javascript:void(0)">栏目(菜单)管理</a></li>
